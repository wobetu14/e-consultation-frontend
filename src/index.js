...
root.render(
  /**
   * The index file is the entry point for any react application.
   ...
   * and <UserProvider>, used to access the logged in user information from UserContext.jsx Context file
   */
