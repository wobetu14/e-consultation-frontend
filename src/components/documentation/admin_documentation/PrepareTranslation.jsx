  ...
  return (
    ...
    >
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header
          title={t("language_tool")}
          subtitle={t("prepare_language_and_convert_to_JSON")}
        />
      </Box>
      <Typography mb="5px">
        <Button
      ...
      {showHowtoDialog && (
        <PrepareLangHowtoDialog
          showHowtoDialog={showHowtoDialog}
          setShowHowtoDialog={setShowHowtoDialog}
        />
      )}
      ...
      <Card sx={{ minWidth: 275 }} variant="outlined">
        <CardContent>
          <form>
            <Typography variant="body1">{t("upload_file")}</Typography>
            <input
              type="file"
              name="upload"
              id="upload"
          ...
          >
            <CardContent>
              ...
              {jsonFile.map((jsonData) => (
                <code key={jsonData} style={{ marginLeft: "20px" }}>
                  <span style={{ color: "#7D3C98" }}>
                    &quot;{jsonData.Word}&quot;
                  </span>
                  <span style={{ color: "white" }}>:</span>
                  <span style={{ color: "#239B56" }}>
