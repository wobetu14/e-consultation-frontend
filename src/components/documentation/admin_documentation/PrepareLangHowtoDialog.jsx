...
const PrepareLangHowtoDialog = ({ showHowtoDialog, setShowHowtoDialog }) => {
  ...
  return (
    <Dialog fullWidth open={showHowtoDialog} maxWidth="lg">
      <DialogTitle
        sx={{ backgroundColor: colors.primary[300], color: colors.grey[300] }}
      >
