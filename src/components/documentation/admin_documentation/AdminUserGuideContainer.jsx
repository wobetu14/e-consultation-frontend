    ...
    <div style={{ marginBottom: "100px" }}>
      ...
      >
        <AccordionSummary aria-controls="panel6d-content" id="panel6d-header">
          <Typography variant="h5">Creating New User</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <CreateNewUserGuide />
        </AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel7d-content" id="panel7d-header">
          <Typography variant="h5">Creating New Sector</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel8d-content" id="panel8d-header">
          <Typography variant="h5">Creating New Institution</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel9d-content" id="panel9d-header">
          <Typography variant="h5">Upload New Draft Document</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <UploadNewDraftGuide />
        </AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel10d-content" id="panel10d-header">
          <Typography variant="h5">Sending Draft Opening Request</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary aria-controls="panel12d-content" id="panel12d-header">
          <Typography variant="h5">External Requests / Invitations</Typography>
        </AccordionSummary>
        <AccordionDetails>
