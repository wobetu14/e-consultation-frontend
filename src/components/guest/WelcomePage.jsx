...
const Course= () => {
	return (
		<div 
        id="course" className='anchroTarget'
        >
...
Of the approximately 1,500 people arrested and brought to the police academy after the riot, officials say that nearly 600 have been taken to other facilities, where police officials have five days to formally charge them.Brazil's judicial authorities have ordered the arrest of top public officials after rioters stormed key government buildings in Brasília.
