...
const ExternalRequestsPreview = () => {
  ...
  return (
    <Box>
        <>
            <Typography variant="h3">Docs Inst ID: {documentDetail? (documentDetail.institution.id):null}</Typography>
            <Typography variant="h3">User's Inst ID: {userInfo.user.institution_id}</Typography>
        </>
      <Box>
        ...
        {/* Actions on the document */}
            {
...

                {
                  (documentDetail && documentDetail.draft_status.name==="Requested") ? (
                    <Chip label={`Status: ${documentDetail.draft_status.name}`} size="small" sx={{ backgroundColor:"orange", color:colors.grey[300]}} />
                  ):""
                }
            ...
            documentDetail && documentDetail.institution.id===userInfo.user.institution_id ? (
            ((documentDetail && documentDetail.draft_status.name==="Pending") || documentDetail && documentDetail.draft_status.name==="Rejected") ? (
              <>
           ...
           (
                (documentDetail && documentDetail.draft_status.name==="Requested") ?(
                    <>
                     <Button variant="contained" color="success" size="small" sx={{ textTransform:"none" }}>Accept</Button>
