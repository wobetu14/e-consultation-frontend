...
export const InstitutionsDataProvider = (props) => {
      ...
      useEffect(()=>{
        const filteredResult=institutions.filter((institution)=>{
            return (
                ...
                institution.email.toLowerCase().match(searchInstitution.toLowerCase()) ||
                institution.address.toLowerCase().match(searchInstitution.toLowerCase()) ||
                institution.telephone.toLowerCase().match(searchInstitution.toLowerCase())
                )
        });
  ...
  return (
    <InstitutionsDataContext.Provider value={{ 
